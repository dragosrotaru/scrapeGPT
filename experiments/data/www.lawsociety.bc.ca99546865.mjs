import puppeteer from "puppeteer";
    ...
    (async () => {
        try {
            ...
            const options = {
  "txt_search_type": "example search type",
  "txt_last_nm": "example last name",
  "txt_given_nm": "example given name",
  "txt_city": "example city"
};
...
async function fillFormAndSubmit(inputs) {
  if(inputs.txt_search_type) {
    await page.select('#txt_search_type', inputs.txt_search_type);
  }
